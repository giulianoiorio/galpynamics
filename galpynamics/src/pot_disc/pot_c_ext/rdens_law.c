 ...
 */
  ...
  /* "galpynamics/src/pot_disc/pot_c_ext/rdens_law.pyx":52
 *     recursiveR=recursiveR*R
 *     res+=a9*recursiveR
 *     res=res #Normalised over sigma0             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_7 = 0;
      __pyx_t_7 = __Pyx_PyObject_GetItem(__pyx_v_ret, __pyx_t_6); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 177, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
...
static PyMethodDef __pyx_methods[] = {
  {"rdens", (PyCFunction)__pyx_pw_11galpynamics_3src_8pot_disc_9pot_c_ext_9rdens_law_1rdens, METH_VARARGS|METH_KEYWORDS, __pyx_doc_11galpynamics_3src_8pot_disc_9pot_c_ext_9rdens_law_rdens},
  {0, 0, 0, 0}
};
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init galpynamics.src.pot_disc.pot_c_ext.rdens_law", 0, __pyx_lineno, __pyx_filename);
    }
